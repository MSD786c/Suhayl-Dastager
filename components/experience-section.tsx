    ...
    <section id="experience" className="py-20 bg-gradient-to-b from-white via-[#F3FAF9] to-[#EAF1F6] dark:from-[#09121A] dark:via-[#0F1F2C] dark:to-[#132736] scroll-mt-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#A63E1B] to-[#E95D2C] dark:from-[#B0CEE2] dark:to-[#45586C] hidden md:block"></div>
          ...
          >
            {experiences.map((experience, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-6 w-4 h-4 bg-gradient-to-r from-[#A63E1B] to-[#E95D2C] dark:from-[#B0CEE2] dark:to-[#45586C] rounded-full border-4 border-white dark:border-[#1A2730] shadow-lg hidden md:block"></div>
                      ...
                      <CardHeader className="pb-4">
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                          <div className="flex-1">
                            <CardTitle className="text-2xl font-bold text-[#1A2730] dark:text-[#B0CEE2] mb-2">
                              {experience.position}
                            </CardTitle>
                            <div className="flex items-center gap-2 text-lg text-[#A63E1B] dark:text-[#B0CEE2] font-semibold mb-2">
                              <Building className="h-5 w-5" />
                              {experience.company}
                            </div>
                            <div className="flex flex-col gap-1 text-[#45586C] dark:text-[#B0CEE2]/80">
                          ...
                          >
                            <Badge 
                              variant="secondary" 
                              className="bg-gradient-to-r from-[#B0CEE2]/50 to-white dark:from-[#424048] dark:to-[#1A2730] text-[#1A2730] dark:text-[#B0CEE2] border-0"
                            >
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          {experience.description.map((desc, descIndex) => (
                            ...
                            >
                              <ChevronRight className="h-5 w-5 text-[#E95D2C] dark:text-[#B0CEE2] mt-0.5 flex-shrink-0" />
                              <p className="text-[#424048] dark:text-[#B0CEE2]/80 leading-relaxed">
                                {desc}
                              </p>
                            </motion.div>
                          ))}
                          ...
                          >
                            {experience.metrics.map((metric) => (
                              <Badge
                                key={metric}
                                variant="outline"
                                className="text-xs uppercase tracking-wide border-[#B0CEE2] dark:border-[#45586C] text-[#1A2730] dark:text-[#B0CEE2]"
                              >
                                {metric}
                              </Badge>
                            ))}
                        ...
                        {experience.company === 'Halliday Forfaiting Services' && (
                          <motion.div
                            ...
                            className="mt-6 p-4 bg-gradient-to-r from-[#B0CEE2]/30 to-white dark:from-[#1A2730] dark:to-[#424048] rounded-lg border border-[#B0CEE2] dark:border-[#45586C]"
                          >
                            <div className="flex items-center gap-2 mb-2">
                              <div className="w-2 h-2 bg-[#E95D2C] dark:bg-[#B0CEE2] rounded-full"></div>
                              <span className="text-sm font-semibold text-[#1A2730] dark:text-[#B0CEE2]">
                                Automation Ops
                              </span>
                            </div>
                            <p className="text-sm text-[#424048] dark:text-[#B0CEE2]/80">
                        ...
                        {experience.company === 'Loop Media' && (
                          <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ delay: 0.5, duration: 0.5 }}
                            className="mt-6 p-4 bg-gradient-to-r from-white to-[#B0CEE2]/30 dark:from-[#1A2730] dark:to-[#424048] rounded-lg border border-[#B0CEE2]/60 dark:border-[#45586C]"
                          >
                            <div className="flex items-center gap-2 mb-2">
                              <div className="w-2 h-2 bg-[#A63E1B] dark:bg-[#B0CEE2] rounded-full"></div>
                              <span className="text-sm font-semibold text-[#A63E1B] dark:text-[#B0CEE2]">
                                Creative Impact
                              </span>
                            </div>
                            <p className="text-sm text-[#424048] dark:text-[#B0CEE2]/80">
