    ...
    <section id="about" className="py-20 bg-white scroll-mt-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600 mt-1">Faster QA cycles</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold gradient-text">50%</div>
                <div className="text-sm text-gray-600 mt-1">Lift in view rates</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold gradient-text">8+</div>
                <div className="text-sm text-gray-600 mt-1">Certs & honors</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            {highlights.map((highlight, index) => (
              <motion.div
                ...
                className="flex items-start space-x-4 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300"
              >
        ...
        <motion.div
          ...
          className="mt-20 p-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl text-white text-center"
        >
